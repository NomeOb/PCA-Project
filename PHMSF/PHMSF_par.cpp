...
struct Graph *build_graph(struct Image image, int maxWeight) {
  ...
  int num_edges = width * height * 2 - image.width - image.height;
...
#pragma omp parallel
  {
    ...
    int xstart, xend, ystart, yend, edge_num;

    int edge_num1 =
        2 * (width)*height / num_threads - (width) - (height / num_threads);

    int edge_num2 =
        edge_num1 + 2 * (width) * (height / num_threads) - height / num_threads;

    int edge_num3 =
        edge_num2 + 2 * (width) * (height / num_threads) - height / num_threads;

    int edge_num4 =
        edge_num3 + 2 * (width) * (height / num_threads) - height / num_threads;

    int edge_num5 =
        edge_num4 + 2 * (width) * (height / num_threads) - height / num_threads;

    int edge_num6 =
        edge_num5 + 2 * (width) * (height / num_threads) - height / num_threads;

    int edge_num7 =
        edge_num6 + 2 * (width) * (height / num_threads) - height / num_threads;

    int edge_num8 =
        edge_num7 + 2 * (width) * (height / num_threads) - height / num_threads;

    int edge_num9 =
        edge_num8 + 2 * (width) * (height / num_threads) - height / num_threads;

    int edge_num10 =
        edge_num9 + 2 * (width) * (height / num_threads) - height / num_threads;

    int edge_num11 = edge_num10 + 2 * (width) * (height / num_threads) -
                     height / num_threads;

    int edge_num12 = edge_num11 + 2 * (width) * (height / num_threads) -
                     height / num_threads;

    int edge_num13 = edge_num12 + 2 * (width) * (height / num_threads) -
                     height / num_threads;

    int edge_num14 = edge_num13 + 2 * (width) * (height / num_threads) -
                     height / num_threads;

    int edge_num15 = edge_num14 + 2 * (width) * (height / num_threads) -
                     height / num_threads;
    switch (tid) {
    case 0:
      edge_num = 0;
      // printf("Thread Num = %d, EDGE NUM = %d\n", tid, edge_num);
      xstart = 0;
      xend = width;
      ystart = 0;
    ...
    case 1:
      ...
      xstart = 0;
      xend = width;
      ystart = height / num_threads;
      yend = 2 * height / num_threads;
      break;
    case 2:
      edge_num = edge_num2;
      // printf("Thread Num = %d, EDGE NUM = %d\n", tid, edge_num);
      xstart = 0;
      xend = width;
      ystart = 2 * height / num_threads;
      yend = 3 * height / num_threads;
      break;
    case 3:
      edge_num = edge_num3;
      // printf("Thread Num = %d, EDGE NUM = %d\n", tid, edge_num);
      xstart = 0;
      xend = width;
      ystart = 3 * height / num_threads;
      yend = 4 * height / num_threads;
      break;
    case 4:
      edge_num = edge_num4;
      // printf("Thread Num = %d, EDGE NUM = %d\n", tid, edge_num);
      xstart = 0;
      xend = width;
      ystart = 4 * height / num_threads;
      yend = 5 * height / num_threads;
      break;
    case 5:
      edge_num = edge_num5;
      // printf("Thread Num = %d, EDGE NUM = %d\n", tid, edge_num);
      xstart = 0;
      xend = width;
      ystart = 5 * height / num_threads;
      yend = 6 * height / num_threads;
      break;
    case 6:
      edge_num = edge_num6;
      // printf("Thread Num = %d, EDGE NUM = %d\n", tid, edge_num);
      xstart = 0;
      xend = width;
      ystart = 6 * height / num_threads;
      yend = 7 * height / num_threads;
      break;
    case 7:
      edge_num = edge_num7;
      // printf("Thread Num = %d, EDGE NUM = %d\n", tid, edge_num);
      xstart = 0;
      xend = width;
      ystart = 7 * height / num_threads;
      yend = 8 * height / num_threads;
      break;
    case 8:
      edge_num = edge_num8;
      // printf("Thread Num = %d, EDGE NUM = %d\n", tid, edge_num);
      xstart = 0;
      xend = width;
      ystart = 8 * height / num_threads;
      yend = 9 * height / num_threads;
      break;
    case 9:
      edge_num = edge_num9;
      // printf("Thread Num = %d, EDGE NUM = %d\n", tid, edge_num);
      xstart = 0;
      xend = width;
      ystart = 9 * height / num_threads;
      yend = 10 * height / num_threads;
      break;
    case 10:
      edge_num = edge_num10;
      // printf("Thread Num = %d, EDGE NUM = %d\n", tid, edge_num);
      xstart = 0;
      xend = width;
      ystart = 10 * height / num_threads;
      yend = 11 * height / num_threads;
      break;
    case 11:
      edge_num = edge_num11;
      // printf("Thread Num = %d, EDGE NUM = %d\n", tid, edge_num);
      xstart = 0;
      xend = width;
      ystart = 11 * height / num_threads;
      yend = 12 * height / num_threads;
      break;
    case 12:
      edge_num = edge_num12;
      // printf("Thread Num = %d, EDGE NUM = %d\n", tid, edge_num);
      xstart = 0;
      xend = width;
      ystart = 12 * height / num_threads;
      yend = 13 * height / num_threads;
      break;
    case 13:
      edge_num = edge_num13;
      // printf("Thread Num = %d, EDGE NUM = %d\n", tid, edge_num);
      xstart = 0;
      xend = width;
      ystart = 13 * height / num_threads;
      yend = 14 * height / num_threads;
      break;
    case 14:
      edge_num = edge_num14;
      // printf("Thread Num = %d, EDGE NUM = %d\n", tid, edge_num);
      xstart = 0;
      xend = width;
      ystart = 14 * height / num_threads;
      yend = 15 * height / num_threads;
      break;
    case 15:
      edge_num = edge_num15;
      // printf("Thread Num = %d, EDGE NUM = %d\n", tid, edge_num);
    ...
    for (int i = ystart; i < yend; i++) {
      for (int j = xstart; j < xend; j++) {
        ...
        // image.pixels[curr_idx].R, image.pixels[curr_idx].G,
        // image.pixels[curr_idx].B); Might not need linear index
        ...
        if (i + 1 < height) {
          ...
          if (weight <= maxWeight) {
            graph->edges[edge_num].n1 = curr_idx;
            graph->edges[edge_num].n2 = top_idx;
            graph->edges[edge_num].weight = weight;
            edge_num++;
          }
        }
        if (j + 1 < width) {
          ...
          int weight =
              getL2norm(image.pixels[curr_idx], image.pixels[right_idx]);
          if (weight <= maxWeight) {
            graph->edges[edge_num].n1 = curr_idx;
            graph->edges[edge_num].n2 = right_idx;
            graph->edges[edge_num].weight = weight;
            edge_num++;
          }
        }
  ...
  //     if (i + 1 < height) {
  //       int top_idx = curr_idx + width;
  //       int weight = getL2norm(image.pixels[curr_idx],
  //       image.pixels[top_idx]); if (weight <= maxWeight) {
  ...
  //       int right_idx = curr_idx + 1;
  //       int weight = getL2norm(image.pixels[curr_idx],
  //       image.pixels[right_idx]); if (weight <= maxWeight) {
  //         graph->edges[edge_cnt].n1 = curr_idx;
...
unsigned int union_find(struct Node *nodes, unsigned int node_id) {
  return nodes[node_id].parent =
             (node_id == nodes[node_id].parent
                  ? node_id
                  : union_find(nodes, nodes[node_id].parent));
}
...
struct Region *find_regions(unsigned int width, unsigned int height,
                            unsigned int minRegionSize, struct Node *nodes) {
...
void edge_heursitc(struct Graph *graph, struct Region *regions,
...
void smooth_image(struct Pixel *pixel, unsigned int width,
                  unsigned int height) {
  int i, j, k, l;
...
int main(int argc, char *argv[]) {
  ...
  struct Region *regions =
      find_regions(image.width, image.height, minRegion, graph->nodes);
  delta = currentSeconds() - start;
...
#pragma omp parallel
  {
    unsigned int threadSeed = omp_get_thread_num();
#pragma omp for schedule(static)
...
#pragma omp atomic
  ...
  std::vector<unsigned char> rawColors(image.width * image.height * 4);
  ...
  lodepng::encode(outImg, rawColors, image.width, image.height);
  delta = currentSeconds() - start;
